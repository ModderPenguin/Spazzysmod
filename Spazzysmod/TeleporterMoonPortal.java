...
public class TeleporterMoonPortal extends Teleporter
{
	...
	public TeleporterMoonPortal(WorldServer par1WorldServer)
	{
			...
			for (int var14 = -2; var14 <= 2; ++var14)
				...
				for (int var15 = -2; var15 <= 2; ++var15)
				{
					for (int var16 = -1; var16 < 3; ++var16)
					{
						...
						this.field_85192_a.setBlock(var17, var18, var19, var20 ? Spazzysmod.cheeseBlock.blockID : 0, 2, 2);
					}
				}
			}
			...
			for (var48 = var15 - var9; var48 <= var15 + var9; ++var48)
			{
				...
				for (int var23 = var16 - var9; var23 <= var16 + var9; ++var23)
				{
					...
					for (int var26 = this.field_85192_a.getActualHeight() - 1; var26 >= 0; --var26)
					{
						...
						{
							while (this.field_85192_a.getBlockId(var48, var26 - 1, var23) == Spazzysmod.moonPortal.blockID)
							{
								--var26;
							}
			...
			for (var19 = -1; var19 <= 1; ++var19)
			{
				for (var20 = 1; var20 < 3; ++var20)
				{
					for (var21 = -1; var21 < 3; ++var21)
					{
						...
						var33 = var21 < 0;
						this.field_85192_a.setBlock(var22, var23, var24, var33 ? Spazzysmod.cheeseBlock.blockID : 0, 2, 2);
					}
				}
			}
		}
		...
		for (var19 = 0; var19 < 4; ++var19)
		{
			...
			for (var20 = 0; var20 < 4; ++var20)
			{
				for (var21 = -1; var21 < 4; ++var21)
				{
					...
					this.field_85192_a.setBlock(var22, var23, var24, var33 ? Spazzysmod.cheeseBlock.blockID : Spazzysmod.moonPortal.blockID, 2, 2);
				}
			}
