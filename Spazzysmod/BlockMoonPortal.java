...
public class BlockMoonPortal extends BlockBreakable
{
    ...
    public boolean tryToCreatePortal(World par1World, int par2, int par3, int par4)
    {
        ...
        if (par1World.getBlockId(par2 - 1, par3, par4) == Spazzysmod.cheeseBlock.blockID || par1World.getBlockId(par2 + 1, par3, par4) == Spazzysmod.cheeseBlock.blockID)
        {
            var5 = 1;
        }

        if (par1World.getBlockId(par2, par3, par4 - 1) == Spazzysmod.cheeseBlock.blockID || par1World.getBlockId(par2, par3, par4 + 1) == Spazzysmod.cheeseBlock.blockID)
        {
            var6 = 1;
        }
        ...
        else
        {
            ...
            for (var7 = -1; var7 <= 2; ++var7)
            {
                for (var8 = -1; var8 <= 3; ++var8)
                {
                    ...
                    if (var7 != -1 && var7 != 2 || var8 != -1 && var8 != 3)
                    {
                        ...
                        else if (var10 != 0 && var10 != Spazzysmod.moonPortal.blockID)
                        {
                            return false;
                        }
                    }
            ...
            for (var7 = 0; var7 < 2; ++var7)
            {
                ...
                {
                    par1World.setBlock(par2 + var5 * var7, par3 + var8, par4 + var6 * var7, this.blockID, 2, 2);
                }
            }
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
     ...
     else
     {
       ...
       for (var9 = 1; var9 < 4 && par1World.getBlockId(par2, var8 + var9, par4) == this.blockID; ++var9)
      {
       ...
       if (var9 == 3 && par1World.getBlockId(par2, var8 + var9, par4) == Spazzysmod.cheeseBlock.blockID)
      {
       ...
       {
        if ((par1World.getBlockId(par2 + var6, par3, par4 + var7) != Spazzysmod.cheeseBlock.blockID || par1World.getBlockId(par2 - var6, par3, par4 - var7) != this.blockID) && (par1World.getBlockId(par2 - var6, par3, par4 - var7) != Spazzysmod.cheeseBlock.blockID || par1World.getBlockId(par2 + var6, par3, par4 + var7) != this.blockID))
        {
         par1World.setBlock(par2, par3, par4, 0, 2, 2);
        }
       }
    	...
    	if (par5Entity.ridingEntity == null && par5Entity.riddenByEntity == null)
    	  {
    	   if (par5Entity instanceof EntityPlayerMP)
    	   {
    	    ...
    	    {
    	     thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, Spazzysmod.moonDimensionID, new TeleporterMoonPortal(thePlayer.mcServer.worldServerForDimension(Spazzysmod.moonDimensionID)));
    	    }
    	    else
    	    {
    	     thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new TeleporterMoonPortal(thePlayer.mcServer.worldServerForDimension(0)));
    	    }
    	   }
    	  }
    }
