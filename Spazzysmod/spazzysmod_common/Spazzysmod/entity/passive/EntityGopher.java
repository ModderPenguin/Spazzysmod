...
public class EntityGopher extends EntityTameable {
    ...
    /**
     * This time increases while wolf is shaking and
     * emitting water particles.
     */
    ...
    /**
     * Determines if an entity can be despawned, used on
     * idle far away entities
     */
    @Override
    ...
    /**
     * Returns true if the mob is currently able to mate
     * with the specified mob.
     */
    @Override
    ...
    /**
     * Returns the item ID for the item the mob drops on
     * death.
     */
    @Override
    ...
    /**
     * The speed it takes to move the entityliving's
     * rotationPitch through the faceEntity method. This is
     * only currently use in wolves.
     */
    @Override
    ...
    /**
     * Called when a player interacts with a mob. e.g. gets
     * milk from a cow, gets into the saddle on a pig.
     */
    @Override
    ...
    /**
     * Checks if the parameter is an item which this animal
     * can be fed to breed it (wheat, carrots or seeds
    ...
    /**
     * This function is used when two same-species animals
     * in 'love mode' breed to generate the new baby animal.
     */
