...
public class ChunkManagerMars implements IChunkProvider {
                    ...
                    for (int var31 = 0; var31 < 8; ++var31) {
                        ...
                        for (int var42 = 0; var42 < 4; ++var42) {
                            ...
                            for (int var51 = 0; var51 < 4; ++var51) {
                                if ((var47 += var49) > 0.0D) {
                                    par3ArrayOfByte[var43 += var44] = (byte) MarsBlocks.marsRock.blockID;
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3) {
        ...
        if (TerrainGen.populate(par1IChunkProvider, worldObj, rand, par2, par3,
            ...
            (new WorldGenLakes(MarsBlocks.marsRock.blockID)).generate(
            ...
            for (int var9 = 0; var9 < 16; ++var9) {
                ...
                for (int var16 = 127; var16 >= 0; --var16) {
                    ...
                    if (var16 <= 0 + this.rand.nextInt(5)) {
                        ...
                        if (var18 == 0) {
                            var13 = -1;
                        } else if (var18 == MarsBlocks.marsRock.blockID) {
                            if (var13 == -1) {
                                if (var12 <= 0) {
                                    var14 = 0;
                                    var15 = (byte) MarsBlocks.marsRock.blockID;
                                ...
                                if (var16 < var5 && var14 == 0) {
                                    ...
                                    // what temperature
                                    if (var11 < 0.15F) {
                                        var14 = (byte) MarsBlocks.marsRock.blockID;
                                    } else {
                                        var14 = (byte) MarsBlocks.marsRock.blockID;
                                    }
                                }
