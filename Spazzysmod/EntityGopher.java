...
public class EntityGopher extends EntityTameable
{
    ...
    {
        super(par1World);
        this.texture = "/mods/" + Spazzysmod.modid + "/textures/models/Gopher.png";
        this.setSize(1.0F, 1.1F);
        this.moveSpeed = 0.3F;
        this.tasks.addTask(1, new EntityAISwimming(this));
        this.tasks.addTask(2, this.aiSit);
        this.tasks.addTask(3, new EntityAITempt(this, 0.25F, Item.carrot.itemID, false));
        ...
        this.targetTasks.addTask(4, new EntityAITargetNonTamed(this, EntityEnderman.class, 16.0F, 200, false));
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        else if (itemstack != null && itemstack.itemID == Item.carrot.itemID && !this.isAngry())
        {
            if (!par1EntityPlayer.capabilities.isCreativeMode)
            {
                --itemstack.stackSize;
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else
        {
            ...
            return !EntityGopher.isTamed() ? false : (EntityGopher.isSitting() ? false : this.isInLove() && EntityGopher.isInLove());
        }
    }
