...
public class ChunkManagerMoon implements IChunkProvider
{
    ...
    public ChunkManagerMoon(World par1World, long par2, boolean par4)
    {
                    ...
                    else
                    {
                        ...
                        else if (var18 == Spazzysmod.moonDirt.blockID)
                        {
                            if (var13 == -1)
                            {
                                ...
                                {
                                	//this has to do with temperatures, make them the same to be the same no matter what temperature
                                    if (var11 < 0.15F)
                                    {
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
                ...
                !var11 && this.rand.nextInt(4) == 0)
        {
            ...
            (new WorldGenLakes(Spazzysmod.moonDirt.blockID)).generate(this.worldObj, this.rand, var12, var13, var14);
        }
        ...
        for (var12 = 0; doGen && var12 < 16; ++var12)
        {
            for (var13 = 0; var13 < 16; ++var13)
            {
                ...
                {
                    this.worldObj.setBlock(var12 + var4, var14 - 1, var13 + var5, Block.ice.blockID, 2, 2);
                }

                if (this.worldObj.canSnowAt(var12 + var4, var14, var13 + var5))
                {
                    this.worldObj.setBlock(var12 + var4, var14, var13 + var5, Block.snow.blockID, 2, 2);
                }
            }
        }
